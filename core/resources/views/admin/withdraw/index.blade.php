                        ...
                        <table class="table table--light style--two custom-data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Status')</th>
                                    @can(['admin.withdraw.method.edit', 'admin.withdraw.method.status'])
                                        <th>@lang('Action')</th>
                                    @endcan
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($methods as $method)
                                    <tr>
                                        ...
                                        <td class="fw-bold">{{ showAmount($method->fixed_charge) }} {{ 0 < $method->percent_charge ? ' + ' . getAmount($method->percent_charge) . ' %' : '' }} </td>
                                        ...
                                        @can(['admin.withdraw.method.edit', 'admin.withdraw.method.status'])
                                            <td>
                                                <div class="button--group">
                                                    @can('admin.withdraw.method.edit')
                                                    ...
                                                    @can('admin.withdraw.method.status')
...
@push('breadcrumb-plugins')
    ...
    @can('admin.withdraw.method.create')
