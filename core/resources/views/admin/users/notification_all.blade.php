            ...
            <div class="row  mb-4 justify-content-center">
                <div class="col-sm-7">
                    <div class="row gy-4 justify-content-center">
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-list" :title="$viaText . ' should be sent'" value="{{ @$sessionData['total_user'] }}" bg="primary" :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-envelope-circle-check" :title="$viaText . ' has been sent'" value="{{ @$sessionData['total_sent'] }}" bg="success" :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-paper-plane" :title="$viaText . ' has yet to be sent'" :viewMoreIcon=false value="{{ @$sessionData['total_user'] - @$sessionData['total_sent'] }}" bg="warning" />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-envelope" :title="$viaText . ' per batch'" value="{{ @$sessionData['batch'] }}" bg="primary" :viewMoreIcon=false />
                        </div>
                        <div class="col-12">
                            <div class="card">
            ...
            <div class="card">
                @if($filterTitle)
                    <div class="card-header">
                        <h6 class="card-title">@php echo $filterTitle @endphp</h6>
                    </div>
                @endif
                <form class="notify-form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                @if (!request()->has('selectedUsers'))
                                    <div class="form-group">
                                        ...
                                        <small class="text--info d-none userCountText"> <i class="las la-info-circle"></i>
                                            <strong class="userCount">0</strong> @lang('users found to send notification')</small>
                                    </div>
                                @else
                                    <input type="hidden" name="being_sent_to" value="filtered_users">
                                @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control nicEdit notificationMessageField" id="nicEdit" name="message" rows="10">{{ old('message', @$sessionData['message']) }}</textarea>
                                    ...
                                    <div class="col-md-4 per-batch-col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch" value="{{ old('batch', @$sessionData['batch']) }}" type="number" placeholder="@lang('How many user')" required>
                    ...
                    @can('admin.users.notification.all.send')
