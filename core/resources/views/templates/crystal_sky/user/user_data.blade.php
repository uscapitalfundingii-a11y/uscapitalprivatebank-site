                    ...
                    <div class="card-body p-sm-5 p-4">
                        ...
                        <form method="POST" action="{{ route('user.data.submit') }}" enctype="multipart/form-data" id="profileOnboardingForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="country" class="form-control form--control select2 wizard-required" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="mobile" value="{{ old('mobile') }}" class="form-control form--control checkUser ps-0 wizard-required" required>
                                            </div>
                            ...
                            <div class="wizard-step" data-step="3">
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <small class="mb-1 text-muted d-block">@lang('Optional: upload a clear profile image in JPG or PNG format.')</small>
                            ...
                            <div class="wizard-actions">
                                ...
                                <button type="button" class="btn btn--base wizard-next">@lang('Continue')</button>
                                <button type="submit" class="btn btn--base wizard-submit d-none">@lang('Complete Profile')</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@push('style')
    <style>
        ...
        .onboarding-intro {
            padding: 1.75rem;
            border-radius: 20px;
            background: linear-gradient(135deg, rgba(70, 52, 255, 0.12), rgba(30, 167, 255, 0.08));
        }
