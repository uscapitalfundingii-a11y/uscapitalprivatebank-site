...
class SupportTicket extends Model {
    ...
    public function scopePending($query) {
        return $query->whereIn('support_tickets.status', [Status::TICKET_OPEN, Status::TICKET_REPLY]);
    }

    public function scopeClosed($query) {
        return $query->where('support_tickets.status', Status::TICKET_CLOSE);
    }

    public function scopeAnswered($query) {
        return $query->where('support_tickets.status', Status::TICKET_ANSWER);
    }
}
