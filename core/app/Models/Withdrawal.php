...
class Withdrawal extends Model {
    ...
    public function scopePending($query) {
        return $query->where('withdrawals.status', Status::PAYMENT_PENDING);
    }

    public function scopeApproved($query) {
        return $query->where('withdrawals.status', Status::PAYMENT_SUCCESS);
    }

    public function scopeRejected($query) {
        return $query->where('withdrawals.status', Status::PAYMENT_REJECT);
    }
}
