...
class PaymentController extends Controller
{
    ...
    public static function userDataUpdate($deposit, $isManual = null)
    {
        if ($deposit->status == Status::PAYMENT_INITIATE || $deposit->status == Status::PAYMENT_PENDING) {
            ...
            if ($deposit->card_id && $deposit->is_topup) {
                ...
                VirtualCardLib::updateCardForTopup($virtualCard, $deposit->amount, $deposit, false);
    ...
    private static function completeVirtualCardIssuing($deposit)
    {
        ...
        try {
            $issuedVirtualCard = VirtualCardLib::issueCard($deposit->card_issue_details, $user, $deposit->amount);
        } catch (\Exception $e) {
            info($e->getMessage());
        }
        ...
        VirtualCardLib::cardIssueCompleted($user, $virtualCard, $deposit->amount);
