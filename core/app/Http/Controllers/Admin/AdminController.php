...
class AdminController extends Controller
{
    private function widgetData()
    {
        ...
        $widget['total_cards']            = VirtualCard::count();
        $widget['active_cards']           = VirtualCard::active()->count();
        $widget['total_topups']           = Topup::count();
        $widget['total_topups_amount']    = Topup::sum('amount');
