...
$(function() {
    ...
    // $('.go-announcements').click(function(e){
    //     e.preventDefault();

    //     window.location.href = site_url + 'clients/announcements';
    // });
...
//     var chart = $('#kt_chart_order_statistics');
//     if (chart.length == 0) {
//         return;
//     }
...
//                     fill: true,
//                     //borderWidth: 0,
//                     backgroundColor: color(KTApp.getStateColor('success')).alpha(0.6).rgbString(),
//                     borderColor : color(KTApp.getStateColor('success')).alpha(0).rgbString(),
//
//                     pointHoverRadius: 4,
//                     pointHoverBorderWidth: 12,
//                     pointBackgroundColor: Chart.helpers.color('#000000').alpha(0).rgbString(),
...
//                     fill: true,
//                     //borderWidth: 0,
//                     backgroundColor: color(KTApp.getStateColor('warning')).alpha(0.6).rgbString(),
//                     borderColor : color(KTApp.getStateColor('warning')).alpha(0).rgbString(),
//
//                     pointHoverRadius: 4,
//                     pointHoverBorderWidth: 12,
//                     pointBackgroundColor: Chart.helpers.color('#000000').alpha(0).rgbString(),
