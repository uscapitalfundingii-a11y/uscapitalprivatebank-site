                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-8">
                                ...
                                <h4 class="tw-mt-2 tw-mb-0 tw-font-semibold tw-truncate"><?php echo count(whatsapp_get_campaign_data($campaign['id'])) ; ?></h4>
                    ...
                    <div class="panel-body">
                        <div class="tw-flex tw-justify-between tw-items-center">
                            ...
                            <div class="<?= is_mobile() ? 'tw-flex tw-flex-col tw-gap-2' : '' ?>">
                                <a href="<?php echo admin_url('whatsapp/campaigns/pause_resume_campaign/' . $campaign['id']); ?>" class="btn btn-primary"><?php echo 1 == $campaign['pause_campaign'] ? "<i class='fa-solid fa-play mright5'></i>" . _l('resume_campaign') : "<i class='fa-solid fa-pause mright5'></i>" . _l('pause_campaign'); ?></a>
                                <a href="<?php echo admin_url('whatsapp/campaigns'); ?>" class="btn btn-primary"><i class="fa-solid fa-backward-step"></i> <?php echo _l('back'); ?></a>
                            </div>
                        </div>
...
<script>
    "use strict";
    initDataTable('.table-campaign_daily_task_table', `${admin_url}whatsapp/campaigns/get_table_data/campaign_daily_task_table/<?php echo $campaign['id'] . '/' . $campaign['rel_type']; ?>`);
</script>
