                ...
                $.each(data, function (user_id, value) {
                    ...
                    if (value.staffid != presenceChannel.members.me.id) {
                        ...
                        if (user != null || isManagedAvailable) {
                            ...
                            if (presenceChannel.members.count > 0) {
                                $(".liveUsers").remove();
                                $("#menu .menu-item-prchat span.menu-text").append("<span class=\"liveUsers badge menu-badge bg-info\" data-toggle=\"tooltip\" title=\"" + prchatSettings.onlineUsersMenu + "\">" + $("#frame #contacts ul li a.on").length + "</span>");
                            }
                        } else {
