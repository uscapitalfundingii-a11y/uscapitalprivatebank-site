        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select data-none-selected-text="<?= _l('chat_non_selected_member_text'); ?>" data-actions-box="true" data-live-search="true" id="members" name="members[]" multiple class="form-control uscap-announcement-select">
                <?php
  ...
  <style>
    #_staffAnnouncementModal .bootstrap-select.uscap-announcement-select,
