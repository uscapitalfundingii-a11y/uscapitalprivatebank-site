...
$lang['utility_import_csv']        = 'Import CSV';
$lang['email_marketing']           = 'Email Marketing';
$lang['email_marketing_intro']     = 'Build and send a paced email campaign to %s active contacts with valid email addresses.';
$lang['email_marketing_send_via_email'] = 'Send Via Email';
$lang['email_marketing_send_via_email_help'] = 'Launch a reusable email broadcast with saved messages and pacing controls.';
$lang['email_marketing_sms_coming_soon'] = 'Send Via SMS';
$lang['email_marketing_sms_coming_soon_help'] = 'SMS delivery can be added next once the email flow is live.';
$lang['email_marketing_push_coming_soon'] = 'Send Via Firebase';
$lang['email_marketing_push_coming_soon_help'] = 'Push notification delivery can be connected after your broadcast workflow is in place.';
$lang['email_marketing_saved_messages'] = 'Saved Broadcast Messages';
$lang['email_marketing_choose_saved_message'] = 'Choose a saved message';
$lang['email_marketing_subject'] = 'Subject';
$lang['email_marketing_message'] = 'Message';
$lang['email_marketing_dictate'] = 'Dictate';
$lang['email_marketing_stop_dictation'] = 'Stop Dictation';
$lang['email_marketing_revise_with_ai'] = 'Revise with AI';
$lang['email_marketing_start_from'] = 'Start From Contact ID';
$lang['email_marketing_per_batch'] = 'Per Batch';
$lang['email_marketing_cooling_period'] = 'Cooling Period (Seconds)';
$lang['email_marketing_rate_hint'] = 'Estimated pace: about %s email(s) per minute with the current batch and delay settings.';
$lang['email_marketing_launch_campaign'] = 'Launch Campaign';
$lang['email_marketing_subject_and_message_required'] = 'Subject and message are required before you can launch the campaign.';
$lang['email_marketing_campaign_progress'] = 'Campaign Progress';
$lang['email_marketing_total_recipients'] = 'Email should be sent';
$lang['email_marketing_sent_count'] = 'Email has been sent';
$lang['email_marketing_remaining_count'] = 'Email has yet to be sent';
$lang['email_marketing_batch_size_label'] = 'Email per batch';
$lang['email_marketing_countdown_message'] = 'Preparing the next batch. The next send window opens in %s seconds.';
$lang['email_marketing_progress_line'] = '%s out of %s email(s) were successfully transmitted.';
$lang['email_marketing_campaign_completed'] = 'Campaign completed.';
$lang['email_marketing_campaign_failed'] = 'Campaign processing failed.';
$lang['email_marketing_ai_revision_failed'] = 'AI revision failed.';
$lang['email_marketing_transcription_failed'] = 'Transcription failed.';
$lang['email_marketing_microphone_denied'] = 'Microphone access was not granted.';
$lang['csv_field_mapping']         = 'CSV Field Mapping';
...
$lang['todo_add_attachments']      = 'Images & Documents';
$lang['todo_view_attachments']     = 'Attached Files';
$lang['todo_attachments_help']     = 'Upload images, PDFs, Word documents, spreadsheets, and other supported files directly to this to-do item.';
...
$lang['email_queue_active_cycle_minutes']                  = 'Active Sending Window (Minutes)';
$lang['email_queue_pause_minutes']                         = 'Pause After Each Window (Minutes)';
...
$lang['email_queue_cycle_note']                            = 'After each active sending window of %s minute(s), the queue will pause for %s minute(s) before it resumes. Use 0 to disable the windowed pause behavior.';
$lang['email_queue_table_recent_note']                     = 'Showing only the 100 most recent queue rows here to keep the settings page lighter during large campaigns.';
