...
*
*/
define('APP_BASE_URL', 'https://projects.uscpb.net/');
...
*/
define('APP_ENC_KEY', '8e0588996b756db66aa2a16d7a6fd219');
 ...
 */
define('APP_DB_USERNAME', 'uscpbp');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Darius1985Angel!?.');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'uscpbp');
...
/**
 * Shared secret for Laravel -> CRM single sign-on.
 */
define('APP_CRM_SSO_SECRET', 'uscpb-crm-sso-2026-04-06-6f5d0d309f5d4468b80c6c71c5298ef4');
