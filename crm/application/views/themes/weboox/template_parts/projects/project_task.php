      ...
      <div class="col-md-12">
         <div class="row">
            <div class="col-md-9">
               ...
               <div class="task-info pull-left no-p-left mr-3">
                  <h5 class="no-margin"><i class="fa fa-bolt"></i>
                     <?php echo _l('task_single_priority'); ?>: <?php echo task_priority($view_task->priority); ?>
                  </h5>
               </div>
               <div class="text-success task-info pull-left mr-3">
                  <h5 class="no-margin"><i class="fa fa-hourglass-start"></i>
                     <?php echo _l('task_single_start_date'); ?>: <?php echo _d($view_task->startdate); ?>
                  </h5>
               </div>
               <div class="task-info pull-left mr-3 <?php if(!$view_task->status != Tasks_model::STATUS_COMPLETE){echo ' text-danger'; }else{echo 'text-info';} ?><?php if(!$view_task->duedate){ echo ' hide';} ?>">
         ...
         <button type="submit" class="btn btn-info mtop10 pull-right mt-3" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off"><?php echo _l('task_single_add_new_comment'); ?></button>
         <div class="clearfix"></div>
         <?php echo form_close(); } ?>
         <?php
