...
<div class="panel_s section-heading section-tickets">
    <div class="panel-body">
        <h4 class="no-margin section-text"><?php echo _l('tickets_summary'); ?></h4>
    </div>
</div>
<div class="panel_s">
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                <!-- <h3 class="text-success pull-left no-mtop tickets-summary-heading"></h3> -->
        ...
        <?php  echo get_template_part('tickets_table'); ?>
    </div>
</div>
</div>
