         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <?php
                  ...
                  echo form_open(site_url('subscription/subscribe/'.$hash), ['class'=>'action-button pull-right']).'
                  <script
                  ...
                  echo form_open(site_url('subscription/subscribe/'.$hash), ['class'=>'action-button pull-right']);
                  echo '<button type="submit" name="source_subscribe" value="true" class="btn btn-success action-button">';
            ...
            <div class="col-md-6 col-md-offset-6">
               <table class="table text-right">
                  <tbody>
                     ...
                     <tr>
                        <td><span class="<?php if($invoice->total_left_to_pay > 0){echo 'text-danger ';} ?>bold">
                           <?php echo _l('invoice_amount_due'); ?></span>
                        </td>
                        <td>
