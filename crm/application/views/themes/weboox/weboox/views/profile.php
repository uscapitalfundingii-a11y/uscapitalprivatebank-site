		...
		<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        		...
        		<div class="kt-subheader__breadcrumbs">
        			...
        			<a href="<?php echo site_url('clients') ?>" class="kt-subheader__breadcrumbs-link">
        				Dashboard	                    </a>
        				<span class="kt-subheader__breadcrumbs-separator"></span>
        				<a href="<?php echo site_url('clients/profile') ?>" class="kt-subheader__breadcrumbs-link">
        					<?php echo _l('clients_profile_heading'); ?>      </a>
        				</div>
        			</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<div class="form-group profile-image-upload-group">
														...
														<p class="text-muted tw-mt-1 tw-mb-0">Choose a JPG or PNG profile photo, then save your profile.</p>
														<input type="file" name="profile_image" class="form-control profile-image-file-input" id="profile_image" accept=".png,.jpg,.jpeg" style="display:block !important; visibility:visible !important; opacity:1 !important; position:static !important; width:100%; height:auto; padding:8px 12px; cursor:pointer;" data-profile-photo-upload="1">
													</div>
												...
												<?php if(can_contact_view_email_notifications_options()){ ?>
													...
													<?php if(has_contact_permission('invoices')){ ?>
														<div class="checkbox checkbox-info email-notifications-invoices">
															<input class="ml-2" type="checkbox" value="1" id="invoice_emails" name="invoice_emails"<?php if($contact->invoice_emails == 1){echo ' checked';} ?>>
															<label for="invoice_emails"><?php echo _l('invoice'); ?></label>
														</div>
														<div class="checkbox checkbox-info email-notifications-credit-notes">
															<input class="ml-2" type="checkbox" value="1" id="credit_note_emails" name="credit_note_emails"<?php if($contact->credit_note_emails == 1){echo ' checked';} ?>>
													...
													<?php if(has_contact_permission('estimates')){ ?>
														<div class="checkbox checkbox-info email-notifications-estimates">
															<input class="ml-2" type="checkbox" value="1" id="estimate_emails" name="estimate_emails"<?php if($contact->estimate_emails == 1){echo ' checked';} ?>>
															<label for="estimate_emails"><?php echo _l('estimate'); ?></label>
														</div>
													<?php } ?>
													<?php if(has_contact_permission('support')){ ?>
														<div class="ml-2"  class="checkbox checkbox-info email-notifications-tickets">
													...
													<?php if(has_contact_permission('contracts')){ ?>
														<div class="ml-2"  class="checkbox checkbox-info email-notifications-contracts">
													...
													<?php if(has_contact_permission('projects')){ ?>
														<div class="checkbox checkbox-info email-notifications-projects">
															<input class="ml-2"  type="checkbox" value="1" id="project_emails" name="project_emails"<?php if($contact->project_emails == 1){echo ' checked';} ?>>
															<label for="project_emails"><?php echo _l('project'); ?></label>
														</div>
														<div class="ml-2"  class="checkbox checkbox-info email-notifications-tasks">
