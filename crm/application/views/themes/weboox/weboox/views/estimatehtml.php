...
<style>
#kt_portlet > div > div > div.mtop15.preview-top-wrapper > div.top > div > div {
    padding-left: 34px;
    padding-right: 26px;
}
                    ...
                    <div class="">
                        <div class="mtop15 preview-top-wrapper">
                           <div class="row">
                              <div class="col-md-3">
                                 <div class="mbot30">
                                    <div class="estimate-html-logo" style="margin-left: 106px;">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="pull-left">
                                          ...
                                          <h4 class="estimate-html-status mtop7 mb-3">
