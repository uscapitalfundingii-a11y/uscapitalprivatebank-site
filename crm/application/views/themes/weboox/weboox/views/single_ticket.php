        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <a href="<?php echo site_url('clients') ?>" class="kt-subheader__breadcrumbs-link">
                ...
                <a href="<?php echo site_url('clients/tickets') ?>" class="kt-subheader__breadcrumbs-link">
                    <?php echo _l('clients_single_ticket_information_heading'); ?>    </a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <?php if($ticket->project_id != 0){ ?>
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        <?php echo _l('ticket_linked_to_project','<a style="color:white; margin-left:5px;" href="'.site_url('clients/project/'.$ticket->project_id).'"><b>'.get_project_name_by_id($ticket->project_id).'</b></a>') ;?>
                                    </div>
                                </div>
                            <?php } ?>
                                        ...
                                        <div class="panel-footer attachments_area">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mtop20 mbot20 text-center">
                                                    <button class="btn btn-info pull-right" type="submit" data-form="#ticket-reply" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('ticket_single_add_reply'); ?></button>
                                                </div>
                                            </div>
                                        </div>
