        ...
        <div class="col-lg-12">
            <div class="kt-portlet" id="kt_portlet">
                <div class="kt-portlet__body"><?php echo validation_errors('<div class="alert alert-danger text-center">', '</div>'); ?>
                    <div class="row">
                        <div class="mtop15 preview-top-wrapper mb-3" style="width:100%;">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="mbot30">
                                    <div class="contract-html-logo mb-3">
                           ...
                           <div class="top" data-sticky data-sticky-class="preview-sticky-header">
                              <div class=" preview-sticky-container contract-sticky-container mb-3" style="padding-left:15px; padding-right:15px;">
                                 <div class="row">
                                    <div class="col-md-12">
                                       <h4 class="pull-left no-mtop contract-html-subject mr-3"><?php echo $contract->subject; ?><br />
                                       ...
                                       <?php } else { ?>
                                       <span class="badge badge-success content-view-status contract-html-is-signed"><?php echo _l('is_signed'); ?></span>
                                       <?php } ?>
                                 ...
                                 <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane<?php if($this->input->get('tab') === 'discussion'){echo ' active';} ?>" id="discussion">
                                       ...
                                       <div class="contract-comment">
                                          ...
                                          <button type="submit" class="btn btn-info mtop10 pull-right mt-3" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('proposal_add_comment'); ?></button>
                                       ...
                                       <?php
                                          ...
                                          foreach ($comments as $comment) {
                                           $comment_html .= '<div class="contract_comment mtop10 mbot20 mt-3" data-commentid="' . $comment['id'] . '">';
                                           if($comment['staffid'] != 0){
                                            $comment_html .= staff_profile_image($comment['staffid'], array(
                                             'staff-profile-image-small',
                                             'media-object img-circle pull-left mright10 mr-3'
                                          ));
                                          }
