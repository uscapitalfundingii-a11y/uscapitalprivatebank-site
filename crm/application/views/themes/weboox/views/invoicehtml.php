...
<div class="kt-container  kt-grid__item kt-grid__item--fluid mt-3">
    <?php if(isset($_SESSION['payment_error'])) { ?>
        <input type="hidden" value="<?php echo $_SESSION['payment_error'] ?>" id="payment_error">
        <?php unset($_SESSION['payment_error']) ?>
    <?php } ?>
    <?php if(isset($_SESSION['payment_success'])) { ?>
        <input type="hidden" value="<?php echo $_SESSION['payment_success'] ?>" id="payment_success">
                ...
                <div class="kt-portlet__body"><?php echo validation_errors('<div class="alert alert-danger text-center">', '</div>'); ?>
                    <div class="mtop15 preview-top-wrapper">
                       <div class="row">
                          <div class="col-md-3">
                             <div class="mbot30">
                                <div class="invoice-html-logo" style="margin-left: 28%; padding-left:12px;">
                       ...
                       <div class="top" data-sticky data-sticky-class="preview-sticky-header">
                          <div class="container preview-sticky-container" style="padding-left:35px; padding-right:35px;">
                             <div class="row">
                                <div class="col-md-12" style="margin-top:80px;">
                                   <div class="pull-left">
                                      ...
                                      <h4 class="invoice-html-status mb-3">
                                         <?php // echo format_invoice_status($invoice->status,'',true); ?>

                                         <span class="text-white badge badge-<?php echo get_invoice_status_label($invoice->status); ?>"><?php echo format_invoice_status($invoice->status, '', false); ?></span>
                                      </h4>
                                   </div>
                                   ...
                                   <button type="submit" name="invoicepdf" value="invoicepdf" class="btn btn-brand pull-right action-button mtop5">
                                   <i class='fa fa-file-pdf-o'></i>
                                   <?php echo _l('clients_invoice_html_btn_download'); ?>
                                   </button>
                                   <?php echo form_close(); ?>
                                   <?php if(is_client_logged_in() && has_contact_permission('invoices')){ ?>
                                   <a href="<?php echo site_url('clients/invoices/'); ?>" class="btn btn-brand pull-right mtop5 mright5 action-button go-to-portal">
                                      ...
                                      <div class="col-md-6 text-left">
                                         ...
                                         <?php foreach($payment_modes as $mode){
                                            if(!is_numeric($mode['id']) && !empty($mode['id'])) {
                                             ...
                                             ?>
                                         <div class="online-payment-radio">
                                        ...
                                        <div id="card_fields" style="display:none;" class="mt-3">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input type="text" class="form-control required-field" name="card_name" placeholder="Como no cartão" data-label="nome do cartão">
                                            </div>
                                            <div class="form-group">
                                                <label>Número do cartão</label>
                                                <input type="text" class="form-control required-field" name="card_number" data-label="número do cartão">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control required-field" name="expiration_month" placeholder="MM" data-label="mês de vencimento">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Ano de vencimento</label>
                                                        <input type="text" class="form-control required-field" name="expiration_year" placeholder="AAAA" data-label="ano de vencimento">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>CVV</label>
                                                <input type="text" class="form-control required-field" name="cvv" maxlength="3" placeholder="CVV" data-label="CVV">
                                            </div>
                                        </div>
