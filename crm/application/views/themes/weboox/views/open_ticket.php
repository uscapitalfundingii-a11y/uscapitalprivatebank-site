...
<script>
    $(function() {
        initWebooxOpenTicketDictation();
    });

    function initWebooxOpenTicketDictation() {
        ...
        $('.ticket-dictate-btn').off('click.weboox-open-ticket-dictation').on('click.weboox-open-ticket-dictation', function() {
            var button = $(this);
