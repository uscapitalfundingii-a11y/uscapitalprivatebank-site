...
<div class="panel_s">
    <div class="panel-body">
        <h3 class="tw-mt-0 tw-font-semibold tw-text-lg">Project Setup &amp; Transaction Management</h3>
        ...
        <h4 class="tw-font-semibold">Step 1: Create a Project</h4>
        ...
        <h4 class="tw-font-semibold">Project Naming Guidelines</h4>
        ...
        <h4 class="tw-font-semibold">Project Configuration</h4>
        <ol>
        ...
        <h4 class="tw-font-semibold">Ongoing Communication</h4>
        <ul>
        ...
        <h4 class="tw-font-semibold">Why This Matters</h4>
        <ul>
        ...
        <p><strong>Important:</strong> Projects serve as the official record for your transaction. Proper setup is essential to ensure timely processing and successful completion of your request.</p>
        <a href="<?= site_url('clients/new_project'); ?>" class="btn btn-primary">New Project</a>
    </div>
</div>
